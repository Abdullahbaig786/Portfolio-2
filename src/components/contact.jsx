      ...
      <div className="max-w-6xl mx-auto px-5 py-24">
        <div className="text-center mb-20">
          ...
          <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
            Feel free to Contact me to this information
          </p>
              ...
              <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                  ...
                  <a
                    ...
                    href="mailto: abdullah.baig2013@gmail.com"
                  >
                    abdullah.baig2013@gmail.com
                  </a>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                  ...
                  <a
                    className="text-lg font-bold text-purple-blue-500"
                    target="_blank"
                    href="https://maps.app.goo.gl/8dZmYp2vHv6SMnju7"
                  >
                    12277 Berlin
                  </a>
                </div>
