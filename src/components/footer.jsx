...
const Footer = () => {
  return (
    <section className="bg-black">
      <hr class="my-3 md:my-6 border-gray-900 opacity-40" />
      <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mt-8 space-x-6">
          <a
            href="https://www.facebook.com/Abdullah.BaiGz"
          ...
          <a
            href="https://instagram.com/abdullah.baigg?igshid=OGQ5ZDc2ODk2ZA%3D%3D&utm_source=qr"
            className="text-gray-400 hover:text-blue-500"
          >
          ...
          <a
            href="https://github.com/Abdullahbaig786"
            className="text-gray-400 hover:text-blue-500"
          >
          ...
          <a
            href="https://www.linkedin.com/in/mirza-abdullah-baig-186856200/"
            className="text-gray-400 hover:text-blue-500"
          >
          ...
          <a
            href="https://www.behance.net/abdullahbaig1"
            className="text-gray-400 hover:text-blue-500"
          >
        ...
        <p className="mt-8 text-base leading-6 text-center text-gray-400">
          © 2021 A, Inc. All rights reserved.
        </p>
      </div>
    </section>
  );
